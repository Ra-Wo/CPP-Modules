...
/*   Updated: 2022/08/26 16:00:40 by roudouch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
    ...
    public:
        FormIsNotSign();
        virtual ~FormIsNotSign() throw();
        FormIsNotSign(FormIsNotSign const &src);
        FormIsNotSign &operator=(FormIsNotSign const &src);
        virtual const char *what() const throw();
    };
};
